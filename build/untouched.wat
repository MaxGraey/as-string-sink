(module
 ...
 (global $assembly/index/MIN_BUFFER_SIZE i32 (i32.const 64))
 (global $assembly/index/NEW_LINE_CHAR i32 (i32.const 10))
 ...
 (export "StringSink#constructor" (func $export:assembly/index/StringSink#constructor@varargs))
 (export "StringSink#get:length" (func $export:assembly/index/StringSink#get:length))
 (export "StringSink#get:capacity" (func $export:assembly/index/StringSink#get:capacity))
 (export "StringSink#write" (func $export:assembly/index/StringSink#write))
 (export "StringSink#writeLn" (func $export:assembly/index/StringSink#writeLn))
 (export "StringSink#writeCodePoint" (func $export:assembly/index/StringSink#writeCodePoint))
 (export "StringSink#clear" (func $export:assembly/index/StringSink#clear))
 (export "StringSink#shrink" (func $export:assembly/index/StringSink#shrink))
 (export "StringSink#toString" (func $export:assembly/index/StringSink#toString))
 (start $~start)
 ...
 (func $assembly/index/StringSink#set:offset (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store offset=4
 )
 (func $assembly/index/StringSink#get:buffer (param $0 i32) (result i32)
  local.get $0
  i32.load
 )
 (func $assembly/index/StringSink#get:offset (param $0 i32) (result i32)
  local.get $0
  i32.load offset=4
 )
 (func $assembly/index/StringSink#get:length (param $0 i32) (result i32)
  local.get $0
  i32.load offset=4
  i32.const 1
  i32.shr_u
 ...
 (func $~lib/rt/__visit_members (param $0 i32) (param $1 i32)
  block $invalid
   block $assembly/index/StringSink
    block $~lib/arraybuffer/ArrayBufferView
     block $~lib/string/String
      block $~lib/arraybuffer/ArrayBuffer
       ...
       i32.sub
       i32.load
       br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $assembly/index/StringSink $invalid
      end
      return
     end
     return
 ...
 (func $assembly/index/StringSink#toString (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
 ...
 (func $assembly/index/StringSink#constructor@varargs (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  local.get $0
  local.get $1
  call $assembly/index/StringSink#constructor
  local.set $2
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
 ...
 (func $export:assembly/index/StringSink#constructor@varargs (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  ...
  local.get $0
  local.get $1
  call $assembly/index/StringSink#constructor@varargs
  local.set $2
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.add
 ...
 (func $export:assembly/index/StringSink#get:length (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  i32.store
  local.get $0
  call $assembly/index/StringSink#get:length
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
 ...
 (func $export:assembly/index/StringSink#get:capacity (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $export:assembly/index/StringSink#write (param $0 i32) (param $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  global.set $~lib/memory/__stack_pointer
  ...
  local.get $0
  local.get $1
  call $assembly/index/StringSink#write
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.add
  global.set $~lib/memory/__stack_pointer
 )
 (func $export:assembly/index/StringSink#writeLn (param $0 i32) (param $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  global.set $~lib/memory/__stack_pointer
  ...
  local.get $0
  local.get $1
  call $assembly/index/StringSink#writeLn
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.add
  global.set $~lib/memory/__stack_pointer
 ...
 (func $export:assembly/index/StringSink#writeCodePoint (param $0 i32) (param $1 i32)
  ...
  local.get $0
  local.get $1
  call $assembly/index/StringSink#writeCodePoint
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
  global.set $~lib/memory/__stack_pointer
 )
 (func $export:assembly/index/StringSink#clear (param $0 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  global.set $~lib/memory/__stack_pointer
  ...
  i32.store
  local.get $0
  call $assembly/index/StringSink#clear
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
  global.set $~lib/memory/__stack_pointer
 ...
 (func $export:assembly/index/StringSink#shrink (param $0 i32)
  ...
  i32.store
  local.get $0
  call $assembly/index/StringSink#shrink
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
  global.set $~lib/memory/__stack_pointer
 ...
 (func $export:assembly/index/StringSink#toString (param $0 i32) (result i32)
  ...
  i32.store
  local.get $0
  call $assembly/index/StringSink#toString
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
